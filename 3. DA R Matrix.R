# MATRIX
# To create a matrix
mat1 = matrix(c(1:20), nrow=4, ncol=5,byrow=TRUE) #nrow = no of rows, ncol= no of columns, byrow= row wiese values assigned
mat1
...
mat1[2,3] # 2, 3 is index no given so it will return the value 12,cz 12 is present in 2nd row and 3rd column
mat1[4,1]
mat1[c(1,2,4),] #row 1,2,4 and all columns will come
mat1[,c(1,2,4)] # all rows and 1, 2,4 column willl come
mat1
...
dimnames(mat1)=dims #dmnames is function to give names to rows and columns
mat1
...
mat2=rbind(mat1,c(26:30)) # rbind is function to add row in matrix
mat2


# To add one more column to a matrix
mat3=cbind(mat1,c(26:30)) # cbind is function
mat3

# Transpose of matrix: to convert rows to columns and columns to rows
mat1
mat4=t(mat1) # t is function to transpose
mat4

# Change row arrangement
mat5=mat1[c(2,3,1,4,5),] # these are the index no of rows in bracket
mat5
...
mat7 = mat5+mat6 # 1st 1st element 2nd 2nd element is added
mat7
...
count=0 # variable we have created
values=c() # empty vector
for (i in x) #for is loop
{
  if(i %% 2 == 0){
    count = count + 1
...
var = readline();
3# convert the inputted value to integer
var = as.integer(var);
# print the value
print(var)
print(var+5)
