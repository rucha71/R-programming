...
var(airquality$Wind) # varience calculation
sd(airquality$Ozone)#,na.rm = T) Standard Deviation # because of NA values in ozone col - No o/p
sd(airquality$Ozone, na.rm = T) # nm.rm used to remove null values
...
kurtosis(airquality$Ozone,na.rm=T) # height of peakness can be measured
...
###############################################################################
## In Class Exercise (homework dataset)
